      ...
      <body className={inter.className}>
        ...
        <nav className="flex flex-wrap items-center justify-between px-4 md:px-8 py-4 bg-white border-b sticky top-0 z-50 shadow-sm">
          ...
          <div className="md:order-3">
            <Link href="/citas">
              <button className="bg-[#C7A268] hover:bg-[#B8925F] text-white px-3 py-1.5 md:px-5 md:py-2 rounded-lg text-xs md:text-sm font-semibold transition shadow-sm">
                Agendar Cita
              </button>
            </Link>
          </div>

          {/* ENLACES: En celular se bajan a una segunda línea centrada, en PC vuelven al medio */}
          <div className="w-full md:w-auto mt-4 md:mt-0 md:order-2">
            <div className="flex justify-center space-x-4 md:space-x-8 text-[11px] md:text-sm font-medium text-gray-700 uppercase tracking-wide">
